...
function seedsRefined=refineInitialSeeds(seedsNEVAL,seedsWmax, seqDataSpecs, options)
...
%     PWMS(:,1:wSeed)=(PWM1L(1:wSeed, :)-PWM0L).';
    ...
    seedEnriched=nestedSeedEnrichment(PWMS, seedsWmax, seqDataSpecs, options);
...
[pvalueNREFSort, sindex]=sort([pvaluesLogEnrchd, -wSeedsNEVAL]);
